            ...
            <form onSubmit={handleSubmit}>
                <div className="sub-container">
                    ...
                    <div style={{paddingTop: '10px'}}>
                        ...
                        <div >
                            <button type="submit" className="btn-submit" onClick={handleListClick} style={{ width: '170px', padding: 0}}>Search</button>  
                            <button type="submit" className="btn-submit" style={{ width: '170px', padding: 0}}>Report</button>  
                        </div>
                        {showTable && (
...
export default GenerarateInvoiceCc;
