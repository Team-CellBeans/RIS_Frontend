  ...
  return (
    <Base>
        ...
        <div className="header-container">
            <b>
            <h5><FaUser style={{marginRight: '10px'}}/>Setting Test Charges & Compliment Charges </h5>
            </b>      
        </div>
        <form onSubmit={handleSubmit}>
            ...
            >
                ...
                <label style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <span style={{ marginLeft: '5px' }}>Patient Name</span>
                </label>
            ...
            <hr />
              <div style={{ display: 'flex', marginBottom: '16px' }}>
                ...
                <div style={{ flex: 1, marginRight: '25px', display: 'flex', alignItems: 'center', marginTop: '25px' }}>
                  ...
                  <button className="btn" >UPDATE CHARGES</button>
                </div>
              </div>
